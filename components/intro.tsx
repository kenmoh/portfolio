...
export default function Intro() {
  ...
  return (
    <section
      ref={ref}
      id="home"
      className="mb-28 max-w-[60rem] text-justify sm:mb-0 scroll-mt-[100rem]"
    >
      ...
      >
        ...
        <a
          ...
          href="https://mohdelivery.s3.amazonaws.com/resume/KennetAremoh.pdf"
          download
        >
          Download CV{" "}
        ...
        <a
          ...
          href="https://www.linkedin.com/in/kenneth-aremoh/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://twitter.com/kennmoh"
          target="_blank"
        >
          <FaTwitterSquare />
        </a>
