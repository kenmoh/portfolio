...
export default function About() {
  ...
  return (
    <motion.section
      ref={ref}
      className="mb-20 max-w-[45rem] text-justify leading-8 sm:mb-30 scroll-mt-28"
    ...
    >
      ...
      <p className="mb-3">
        ...
        <span className="font-medium">full-time or contact position</span> as a
        software developer.
      </p>

      <p>
        <span className="italic">When I'm not coding</span>, I enjoy playing
        football, watching movies, readding books.
      </p>
    </motion.section>
  );
}
